...
<template>
  <section
    class="relative bgDark px-[1rem] pt-[12rem] py-[6rem] flex flex-wrap justify-center items-center gap-[4rem] sm:gap-[6rem] sm:pt-[13rem] sm:px-[1.5rem] md:px-[2rem] md:gap-[8rem] lg:pt-[14rem] xxxl:pb-[8rem] xxxxl:gap-[10rem] xxxxl:pb-[10rem] xxxxl:px-[4rem]"
  >
    <h2
      class="absolute top-[3.5rem] left-[50%] translate-x-[-50%] leading-none tracking-tighter text-[4.5rem] font-semibold text-textDark xs:text-[5rem] sm:text-[9rem] sm:top-[-.5rem] sm:left-0 sm:translate-x-0 md:text-[13rem] md:top-[-1rem] lg:top-[-1.5rem] lg:text-[16rem] xxxl:top-[-2rem] xxxl:text-[20rem]"
    >
      classes
    </h2>
    <div
